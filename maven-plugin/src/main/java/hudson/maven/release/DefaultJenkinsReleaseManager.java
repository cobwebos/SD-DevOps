...
public class DefaultJenkinsReleaseManager implements JenkinsReleaseManager {
	...
	/**
	 * @see hudson.maven.release.JenkinsReleaseManager#getPreparedReleases()
	 */
	@Override
	...
	/**
	 * @see hudson.maven.release.JenkinsReleaseManager#getReleaseResults()
	 */
	@Override
	...
	/**
	 * @see hudson.maven.release.JenkinsReleaseManager#sanitizeTagName(java.lang.String,
	 *      java.lang.String)
	 */
	@Override
