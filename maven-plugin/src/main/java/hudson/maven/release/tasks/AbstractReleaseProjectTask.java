 ...
 * @version $Id: AbstractReleaseProjectTask.java 763036 2009-04-07 23:36:34Z
 *          olamy $
 */
public abstract class AbstractReleaseProjectTask implements Task, ReleaseProjectTask {
	...
	private JenkinsReleaseDescriptor descriptor;
	...
	public AbstractReleaseProjectTask(String releaseId, ReleaseDescriptor descriptor, ReleaseManagerListener listener) {
		...
		this.descriptor = (JenkinsReleaseDescriptor) descriptor;
		this.listener = listener;
	}

	public JenkinsReleaseDescriptor getDescriptor() {
		return descriptor;
	}
